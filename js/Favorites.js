...
export class FavoritesView extends Favorites {
  ...
  update() {
    ...
    if (this.entries.length === 0) {
      const noUsers = document.createElement('tr') 
      noUsers.innerHTML = `
      <div class="no-users">
      <svg
        width="132"
  ...
  createRow() {
    ...
    <td class="user">
    <img
    src="https://github.com/Dericones.png"
    alt="Imagem de Déryck Souza"
        />
        <a href="https://github.com/Dericones" target="_blank">
        <p>Déryck Souza</p>
        <span>Dericones</span>
        </a>
        </td>
